...
describe('RGBColor', () => {
  it('should convert to CSS string', () => {
    ...
    expect(c.toCSSString()).toBe('rgba(25.500 51.000 76.500 0.400)');
  });
});
...
describe('HSBColor', () => {
  it('should convert to CSS string', () => {
    ...
    expect(c.toCSSString()).toBe('hsla(36.000 11.111% 27.000% 0.400)');
  });
});
...
describe('HSLColor', () => {
  it('should convert to CSS string', () => {
    ...
    expect(c.toCSSString()).toBe('hsla(36.000 20.000% 30.000% 0.400)');
  });
});